import { ThreeWayPartitioningQuickSort } from './three-way-partitioning-quick-sort';
import { Comparator } from '../../../util/comparator';
import { isCorrectOrder, generateRandomNumberArr } from '../../../util/helper.util';

describe('ThreeWayPartitioningQuickSort', () => {
  test('TestCase 1: should work', () => {
    const arr: number[] = generateRandomNumberArr(10000000);
    ...
    ThreeWayPartitioningQuickSort.sort(arr, numberComparator);
  ...
  test('TestCase 2: should work', () => {
    ...
    ThreeWayPartitioningQuickSort.sort(arr, ageComparator);
